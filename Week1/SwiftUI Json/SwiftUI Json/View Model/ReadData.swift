...
class ReadData: ObservableObject {
    ...
    func loadData(){
        //ใช้เคำสั่ง guard และคำสั่ง if let เพื่อตรวจสอบว่า ไฟล์ zodiac.json มีอยู่หรือไม่
        guard let url = Bundle.main.url(forResource: "zodiac", withExtension: "json")
        else{
        ...
        self.zodiacs = zodiacs! //ใส่ ! เพื่อ unwrap ค่าว่าไม่เป็น nil
    }
}
